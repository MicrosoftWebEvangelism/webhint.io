---
category: "user-guide"
description: "This hint validates the set-cookie header and confirms that theSecure and HttpOnly directives are defined when sent from asecure origin (HTTPS)."
layout: "docs"
originalFile: "docs/user-guide/hints/hint-validate-set-cookie-header.md"
permalink: "docs/user-guide/hints/hint-validate-set-cookie-header/index.html"
