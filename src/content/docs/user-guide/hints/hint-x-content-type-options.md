---
category: "user-guide"
description: "x-content-type-options requires that all scripts andstylesheets are served with the X-Content-Type-Options: nosniffHTTP response header."
layout: "docs"
originalFile: "docs/user-guide/hints/hint-x-content-type-options.md"
permalink: "docs/user-guide/hints/hint-x-content-type-options/index.html"
