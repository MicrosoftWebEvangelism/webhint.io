---
category: "user-guide"
description: "no-p3p disallows the use of P3P in any form (headers, rel attribute, andwell-known location)."
layout: "docs"
originalFile: "docs/user-guide/hints/hint-no-p3p.md"
permalink: "docs/user-guide/hints/hint-no-p3p/index.html"
title: "Disallow `P3P` headers"
tocTitle: "hints"
contentType: "details"
---
