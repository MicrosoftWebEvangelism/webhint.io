---
category: "user-guide"
description: "meta-theme-color hint checks if a single theme-color meta tagis specified in the `` with a valid value supported by all useragents."
layout: "docs"
originalFile: "docs/user-guide/hints/hint-meta-theme-color.md"
permalink: "docs/user-guide/hints/hint-meta-theme-color/index.html"
