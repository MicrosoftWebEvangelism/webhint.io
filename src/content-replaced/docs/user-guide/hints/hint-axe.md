---
category: "user-guide"
description: "aXe is the accessibility engine for automated testing of HTML-baseduser interfaces. This hint performs the default accessibility tests(WCAG 2.0 Level A and Level AA rules) and alerts if something fails."
layout: "docs"
originalFile: "docs/user-guide/hints/hint-axe.md"
permalink: "docs/user-guide/hints/hint-axe/index.html"
